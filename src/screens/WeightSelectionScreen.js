...
export default function WeightSelectionScreen({navigation}) {
  ...
  const data = Array.from({ length: 161 }, (_, i) => 40 + i)
  ...
  useEffect(() => {
    ...
    setSelectedNumber(40 + visibleIndexes + 2)
    console.log("Number at center:", 40 + visibleIndexes + 2)
  }, [scrollPosition])
    ...
    <SafeAreaProvider>
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.buttonsContainer}>
          <TouchableOpacity style={[styles.button, styles.backButton]} onPress={() => navigation.navigate("AgeSelectionScreen")}>
