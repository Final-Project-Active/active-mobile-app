...
export default function HeightSelectionScreen({navigation}) {
  ...
  const data = Array.from({ length: 51 }, (_, i) => 150 + i)
  ...
  useEffect(() => {
    ...
    setSelectedNumber(150 + visibleIndexes + 2)
    console.log("Number at center:", 150 + visibleIndexes + 2)
  }, [scrollPosition])
    ...
    <SafeAreaProvider>
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.buttonsContainer}>
          <TouchableOpacity style={[styles.button, styles.backButton]} onPress={() => navigation.navigate("WeightSelectionScreen")}>
